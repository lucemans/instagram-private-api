...
[Globals](../globals.md) / ["errors/ig-login-invalid-user.error"](../modules/_errors_ig_login_invalid_user_error_.md) / [IgLoginInvalidUserError](_errors_ig_login_invalid_user_error_.iglogininvalidusererror.md) /
