...
[Globals](../globals.md) / ["types/media.configure-story.options"](../modules/_types_media_configure_story_options_.md) / [StoryMention](_types_media_configure_story_options_.storymention.md) /
...
*Defined in [types/media.configure-story.options.ts:137](https://github.com/Nerixyz/instagram-private-api/blob/e5037ee/src/types/media.configure-story.options.ts#L137)*
