...
[Globals](../globals.md) / ["types/common.types"](_types_common_types_.md) /
...
*Defined in [types/common.types.ts:3](https://github.com/Nerixyz/instagram-private-api/blob/e5037ee/src/types/common.types.ts#L3)*
...
*Defined in [types/common.types.ts:30](https://github.com/Nerixyz/instagram-private-api/blob/e5037ee/src/types/common.types.ts#L30)*